...
func init() {
	//                    Name      LenType      FixLen
	InfoMap[0x04] = Info{"amount in cent", blen.Length{Kind: NONE, Value: 6}}
	InfoMap[0x05] = Info{"pump number", blen.Length{Kind: NONE, Value: 1}}
	InfoMap[0xF1] = Info{"Text1 line 1", blen.Length{Kind: LL}}
	InfoMap[0xF2] = Info{"Text1 line 2", blen.Length{Kind: LL}}
	InfoMap[0xF3] = Info{"Text1 line 3", blen.Length{Kind: LL}}
	InfoMap[0xF4] = Info{"Text1 line 4", blen.Length{Kind: LL}}
}
